...
const spanish = "Por esa razón ofrecemos una traducción simultánea durante todo el evento. <br> Por medio de auriculares pueden nuestros invitados participar. Momentáneamente les ofrecemos una traducción en <strong>español</strong> , <strong>portugués</strong>, <strong>inglés</strong>  y <strong>francés </strong> <br> </p>";

const portugese_h2 = "Até 20 diferentes nações visitam nosso culto regularmente.";
const portugese = "É por isso que oferecemos tradução simultânea durante todo o evento.<br> Com fones de ouvido, nossos visitantes podem participar em seu próprio idioma. Atualmente oferecemos tradução em <strong>espanhol</strong>, <strong>português</strong>, <strong>inglês</strong> e <strong>francês</strong>.";
...
const french = "C'est pour cela que nous avons mus à votre disposition une traduction pour que vous puissiez suivre le culte a l'aide de casque. <br> A l'heure actuel on propose comme traduction du <strong>espagnol</strong>, <strong>portugais</strong>, <strong>anglais</strong> et <strong>français</strong>.";
